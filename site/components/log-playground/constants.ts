...
export const TEXT_DESCRIPTION = "Paste your logs below and see them transformed in real-time";
...
export const CLASS_HEADER_TITLE = "mb-4 text-center text-5xl lg:text-6xl font-bold";
export const CLASS_HEADER_GRADIENT = "bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent";
export const CLASS_HEADER_DESCRIPTION = "mb-12 text-center text-xl text-slate-600 dark:text-slate-400";
export const CLASS_CARD_HEADER = "flex flex-row items-center justify-between pb-4";
...
export const CLASS_PANE_WRAPPER = "border rounded-lg overflow-hidden dark:border-slate-700";
export const CLASS_PANE_HEADER = "px-4 py-2 bg-slate-800 text-white text-sm font-medium";
export const CLASS_TEXTAREA = "w-full h-full min-h-[400px] p-4 font-mono text-sm bg-slate-50 dark:bg-slate-900 border-0 resize-none focus:outline-none";
export const CLASS_OUTPUT_CONTENT = "flex-1 p-4 font-mono text-xs overflow-auto min-h-[400px]";
