...
export const styleOptionsSchema = z.object({
  ...
  htmlStyleFormat: z.enum(['css', 'className']).optional().describe('HTML style format')
});

export const tokenMetadataSchema = z.object({
  style: styleOptionsSchema.optional().describe('Styling information for this token')
...
export const tokenSchema = z.object({
  ...
  metadata: tokenMetadataSchema.describe('Additional token metadata including style information')
});
